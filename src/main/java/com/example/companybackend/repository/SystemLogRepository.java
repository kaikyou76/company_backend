...
public interface SystemLogRepository extends JpaRepository<SystemLog, Integer> {
        ...
        List<SystemLog> findByCreatedAtBetween(@Param("startDate") OffsetDateTime startDate,
         ...
         * @return 過去N時間のログリスト
         */
        @Query(nativeQuery = true, value = "SELECT sl.* FROM system_logs sl WHERE sl.created_at >= CURRENT_TIMESTAMP - INTERVAL '1 hour' * :hours ORDER BY sl.created_at DESC")
        ...
        @Query(nativeQuery = true, value = """
                        ...
                        """)
        List<java.util.Map<String, Object>> getActionStatistics(@Param("startDate") OffsetDateTime startDate,
                        @Param("endDate") OffsetDateTime endDate);
        ...
        @Query(nativeQuery = true, value = """
                        ...
                        ORDER BY COUNT(sl) DESC
                        """)
        List<java.util.Map<String, Object>> getUserActivityStatistics(@Param("startDate") OffsetDateTime startDate,
                        @Param("endDate") OffsetDateTime endDate);
        ...
        @Query(nativeQuery = true, value = """
                        ...
                        ORDER BY COUNT(sl) DESC
                        """)
        List<java.util.Map<String, Object>> getIpAccessStatistics(@Param("startDate") OffsetDateTime startDate,
                        @Param("endDate") OffsetDateTime endDate);
        ...
        @Query(nativeQuery = true, value = """
                        ...
                        """)
        List<java.util.Map<String, Object>> getHourlyActivityStatistics(@Param("startDate") OffsetDateTime startDate,
                        @Param("endDate") OffsetDateTime endDate);
         ...
         * @return 失敗ログイン試行リスト
         */
        @Query(nativeQuery = true, value = "SELECT sl.* FROM system_logs sl WHERE sl.action LIKE '%login%failed%' AND sl.created_at >= CURRENT_TIMESTAMP - INTERVAL '1 hour' * :hours ORDER BY sl.created_at DESC")
        ...
        @Query(nativeQuery = true, value = """
                        ...
                        ORDER BY COUNT(sl) DESC
                        """)
        List<java.util.Map<String, Object>> getUserAgentStatistics(@Param("startDate") OffsetDateTime startDate,
                        @Param("endDate") OffsetDateTime endDate);
        ...
        long countByCreatedAtBetween(@Param("startDate") OffsetDateTime startDate,
                        @Param("endDate") OffsetDateTime endDate);
        ...
        @Query(nativeQuery = true, value = """
                        SELECT sl.* FROM system_logs sl
                        WHERE (:action IS NULL OR sl.action = CAST(:action AS TEXT))
                        AND (:status IS NULL OR sl.status = CAST(:status AS TEXT))
                        AND (:startDate IS NULL OR sl.created_at >= CAST(:startDate AS TIMESTAMP WITH TIME ZONE))
                        AND (:endDate IS NULL OR sl.created_at <= CAST(:endDate AS TIMESTAMP WITH TIME ZONE))
