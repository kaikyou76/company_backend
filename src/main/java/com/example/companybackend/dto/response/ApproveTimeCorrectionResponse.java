...
public class ApproveTimeCorrectionResponse {
    private boolean success;
    private String message;
    private TimeCorrection correction;

    public ApproveTimeCorrectionResponse() {}

    public ApproveTimeCorrectionResponse(boolean success, String message, TimeCorrection correction) {
